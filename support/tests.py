...
class SupportTestCase(TestCase):
    ...
    def test_get_create_cart(self):
        ...
        client_email = "testing@domain.com"
        create_client_data = json.dumps({
            "first_name": "Testing Firstname",
            "last_name": "Testing Lastname",
            "company": "Testing Company",
            "phone": "3101234567",
        ...
        create_client_response = c.post('/support/get-or-create-client/', content_type='application/json', data=create_client_data)
